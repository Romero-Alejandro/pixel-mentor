...
import type { ConsentStatus, ParentalConsent } from '@/domain/entities/parental-consent.js';
import type { ParentalConsentRepository } from '@/domain/ports/parental-consent-repository.js';
